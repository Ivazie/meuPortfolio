...
const Hero = () => {
  return (
    ...
    bg-bottom bg-over dark:bg-none">
      <div className="container mx-auto">
        <div className="flex justify-between gap-x-8">
          {/* text */}
          <div className="flex max-w-[600px] flex-col justify-center mx-auto xl:mx-0 text-center xl:text-left">
            <div className="text-sm uppercase font-semibold mb-4 text-primary tracking-[4px]">Web Developer</div>
            <h1 className="h1 mb-4">Oie, meu nome é Vitoria Grazielle</h1>
            <p className="subtitle max-w-[490px] mx-auto xl:mx-0">faça uma breve descrição pessoal</p>
             {/* buttons */}
          ...
          <div className='hidden xl:flex relative'>
            ...
            <DevImg containerStyles='bg-hero_shape w-[510px] h-[462] bg-no-repeat
             relative bg-bottom'
